...
# for(t in 1:length(types)){
  ...
  for (j in 1:length(burns)){
    ...
    #https://stats.stackexchange.com/questions/131074/metrics-for-multi-class-problems-in-r-caret-package-for-various-method-tags
    ...
    ggsave(paste0(gdir, "cm\\cm_", labs[t], "_",df.w$BURNID[1], "_rf.jpg" ), width = 7, height = 4)
  ...
  write.csv(ck.all, paste0(here("predict"), "/predict_ibra_L8_", labs[t],".csv"))
  saveRDS(cm.df.all, paste0(here("rds.files"), "/cm.type.L8.",labs[t],".", Sys.Date()))
}
stopCluster(cl)